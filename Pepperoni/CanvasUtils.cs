...
namespace Pepperoni
{
    ...
    {
        /// <summary>
        /// Access to the Arial Font
        /// </summary>
        public static Font Arial;

        /// <summary>
        /// Access to default UI Font
        /// </summary>
        ...
        public class RectData
        {
            ...
            /// and if you wanted a fullscreen wide box, its just 0 because 1920+0 = 1920
            /// the same applies for height</param>
            /// <param name="anchorPosition">Relative Offset Position where Element is anchored as compared to Min / Max</param>
            /// <param name="min">Describes 1 corner of the rectangle
            /// 0,0 = bottom left
            /// 0,1 = top left
            /// 1,0 = bottom right
        ...
        /// <returns></returns>
        public static GameObject CreateCanvas(RenderMode renderMode, int referencePixelsPerUnit, Camera camera = null)
        {
        ...
        /// <returns></returns>
        public static GameObject CreateCanvas(RenderMode renderMode, Vector2 size, Camera camera = null)
        {
            GameObject c = new GameObject();
            c.AddComponent<Canvas>().renderMode = renderMode;
            if (renderMode == RenderMode.ScreenSpaceCamera)
        ...
        {
            return CreateTextPanel(parent, text, fontSize, textAnchor, rectData, Arial);
        }

        public static GameObject CreateTMProPanel(GameObject parent, string text, float fontSize, TextAnchor textAnchor, RectData rectData, TMP_FontAsset font)
        {
            GameObject panel = CreateBasePanel(parent, rectData);
        ...
        public static GameObject CreateButton(GameObject parent, Action<int> action, int id, Sprite spr, string text, int fontSize, TextAnchor textAnchor, RectData rectData, bool bold = true, params Sprite[] extraSprites)
        {
            ...
            UnityEngine.UI.Button button = panel.AddComponent<UnityEngine.UI.Button>();
